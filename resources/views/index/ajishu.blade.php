...
@section('title','爱技术 - K先生个人博客')
@section('keywords','爱技术,K先生,K先生个人博客')
@section('description','分享个人学习经验和技术-K先生个人博客')

@section('content')
    <div class="row">
        <div class="col-md-7">
            <p class="top_nav_P">
                您现在的位置是：<a href="/">首页</a> > <a href="/">爱技术</a>
                <span class="f_r music_p d_none">我喜欢的是你，而不是技术</span>
            </p>
