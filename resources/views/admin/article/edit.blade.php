...
@section('content')
    <div class="main" style="">
        <div class="main-content">
            <div class="main-top">
                <p class="mbaoxie"><a href="/">首页</a><span>/</span>编辑文章</p>
                ...
                <div class="main-box">
                    <form action="#" method="POST">
                        ...
                        <div class="m_input_item">
                            <label>标题:</label>
                            <div class="m_input_box"><input class="m_input" value="{{$article->title ?? ''}}" required type="text" name="title"></div>
                        </div>
                        <div class="m_input_item">
                            <label>类别：</label>
                        ...
                        <div class="simeditor_div" style="display: flex;margin: 30px 0;">
                            ...
                            <textarea id="editor" required name="content" autofocus>{{$article->content ?? ''}}</textarea>
                        </div>
                        <div class="m_input_item">
                            <label>关键词:</label>
                            <div class="m_input_box"><input class="m_input" value="{{$article->keywords ?? ''}}" required type="text" placeholder="英文逗号隔开" name="keywords"></div>
                        </div>
                        <div class="m_input_item">
                            <label>摘要:</label>
                            <div class="m_input_box"><input class="m_input" value="{{$article->description ?? ''}}" type="text" placeholder="选填" name="description"></div>
                        </div>
                        ...
                        <div class="m_input_item">
                            <label></label>
                            <button id="fb_btn" class="m_btn" type="submit">更新</button>
